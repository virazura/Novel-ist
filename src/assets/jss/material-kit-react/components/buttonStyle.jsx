...
const buttonStyle = {
  ...
  montecarlo: {
    ...
    boxShadow:
      "0 2px 2px 0 rgba(204, 149, 192, 0.14), 0 3px 1px -2px rgba(204, 149, 192,0.2), 0 1px 5px 0 rgba(204, 149, 192, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: monteCarloColor,
      boxShadow:
        "0 14px 26px -12px rgba(204, 149, 192, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(204, 149, 192, 0.2)"
    }
  },
  seaweed: {
    backgroundColor: seaWeedColor,
    boxShadow:
      "0 2px 2px 0 rgba(60, 211, 173, 0.14), 0 3px 1px -2px rgba(60, 211, 173,0.2), 0 1px 5px 0 rgba(60, 211, 173, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: seaWeedColor,
      boxShadow:
        "0 14px 26px -12px rgba(60, 211, 173, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(60, 211, 173, 0.2)"
    }
  },
  info: {
